...
[3 环境配置与使用方法](#3-环境配置与使用方法)

    [3.1 注意事项](#3.1-注意事项)

​	[3.2 final文件夹下内容简介](#3.2-final文件夹下内容简介)

​	[3.3 使用方法](#3.3-使用方法)

​		[3.3.1 简单测试](#3.3.1-简单测试)

​		[3.3.2 多机测试](#3.3.2-多机测试)

​	[4 设计与实现](#4-设计与实现)

​		[4.1 yijinjing](#4.1-yijinjing)

​		[4.1.1 为什么选择易筋经](#4.1.1-为什么选择易筋经)

​		[4.1.2 测试写入时间](#4.1.2-测试写入时间)

​			[4.1.2.1 C++/yijinjing](#4.1.2.1-C++/yijinjing)

​			[4.1.2.2 python/yijinjing](#4.1.2.2-python/yijinjing)

​			[4.1.2.3 python/MySQL](#4.1.2.3-python/MySQL)

​		[4.1.3 接口实现](#4.1.3-接口实现)

​		[4.2 Rain](#4.2-Rain)

​		[4.3 拼接](#4.3-拼接)

[5 基于平台实现的应用:量化交易工具](#5-基于平台实现的应用:量化交易工具)

​	[5.1 整体架构](#5.1-整体架构)

​	[5.2 量化交易简介](#5.2-量化交易简介)

​	[5.3 均线策略简介](#5.3-均线策略简介)

​	[5.4 数据获取](#5.4-数据获取)

​	[5.5 结果展示](#5.5-结果展示)

[6 改进、展望与总结](#6-改进、展望与总结)

​	[6.1 目前项目存在的问题](#6.1-目前项目存在的问题)
